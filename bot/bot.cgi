...
# A basic HTML template creating a basic page with a form and text
...
#If user supplies some text, respond to it
...
# Format the text and substitute in the HTML template 
# as well sending the MIME header for HTML support
